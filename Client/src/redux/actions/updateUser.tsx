...
const updateUser = (user: any) => {
  return async (dispatch: Dispatch<AnyAction>) => {
    try {
      ...
      await axios.put(`pfback-production-a519.up.railway.app/users/update/${id_user}`, updatedUser);
...
//     try {
//       const { id_user } = user;
//       await axios.post(`pfback-production-a519.up.railway.app/users/update/${id_user}`, user);
