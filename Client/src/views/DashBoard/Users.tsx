...
///////////////////////////////////////////////
    ...
    const sendUpdateUser = async () => {
        await axios.put("https://pf-airbnb.vercel.app/?users/update/" + user.id_user, updateUser);
...
const DashUsers = () => {
    ...
    useEffect(() => {
        async function fetchProperties() {
            try {
                const response = await axios.get("https://pf-airbnb.vercel.app/?users/"); // Ajusta la URL de la solicitud según corresponda
