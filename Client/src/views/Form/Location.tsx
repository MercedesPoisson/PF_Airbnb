    ...
    return (
        ...
        <div className="items-center">
         <div className="relative">
           <input className="pl-8 w-96 h-10 border rounded-md mb-2" type="text" placeholder="Ingrese la dirección" />
           <i className="fa fa-location-dot absolute left-2 top-3 text-gray-600"></i>
         </div>
         <div className="relative">
           <input className="pl-8 w-96 h-10 border rounded-md mb-2" type="text" placeholder="Ingrese la localidad" />
           <i className="fa fa-location-dot absolute left-2 top-3 text-gray-600"></i>
         </div>
         <div className="relative ">
