...
const Location = (props: LocationProps) => {
  ...
  useEffect(() => {
    const fetchProvinces = async () => {
      try {
        const response = await axios.get("https://pfback-production-a519.up.railway.app/locations");
      ...
      const fetchLocations = async () => {
        try {
          const response = await axios.get(
            `https://pfback-production-a519.up.railway.app/locations/${selectedProvince?.value}?city=${searchValue}`
          );
