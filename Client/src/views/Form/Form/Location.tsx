...
const Location = (props: LocationProps) => {
  ...
  useEffect(() => {
    const fetchProvinces = async () => {
      try {
        const response = await axios.get("https://backofback-production.up.railway.app/locations");
      ...
      const fetchLocations = async () => {
        try {
          const response = await axios.get(
            `https://backofback-production.up.railway.app/locations/${selectedProvince?.value}?city=${searchValue}`
          );
