...
<div className="row-span-2 border hover:border-primero hover:animate-lightup w-[450px] ml-10 mb-10" onClick={handleNavigateToVacaciones}>
...
<div className="row-span-2 border hover:border-primero hover:animate-lightup w-[450px] ml-10 mb-10" onClick={handleNavigateToReservas}>
        <h5 className="flex items-center justify-between uppercase font-bold bg-primero text-white px-2 py-2">
